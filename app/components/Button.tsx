...
const Button = ({ showId }: { showId: string }) => {
  return (
    <StyledWrapper>
      <Link
        href={`/series/${showId}`}
        className="flex w-[170px] bg-[#e50914] rounded-[40px] justify-between items-center no-underline px-3 py-1.5 cursor-pointer transition-colors duration-300 hover:bg-[#b00710]"
      >
